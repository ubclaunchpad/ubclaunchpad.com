enum goals {
  ...
  // when a user clicks anything inside a project modal
  PROJECTMODAL_INTERACTION = 'INWBK8ID',

  // when a user clicks one of our social links
  SOCIALS_CLICK = 'WQWZMWMV',

  // when a user clicks one of the big buttons in the landing section
  CALLTOACTION_CLICK = 'AEL83VZC',
